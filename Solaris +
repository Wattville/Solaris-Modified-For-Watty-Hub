...
-- loops through tab and checks if any of the values are equal to key if any is it returns true
...
-- gets the notification gui and gets the SCRIPT that has a script inside that is used 4 notifications
...
--[[ INSIDE THE NOTIFICATION SCRIPT
...
local SolarisLib = {
	...
	BloodRed = {
            ...
            Button = Color3.fromRGB(33, 43, 54),
            ButtonHold = Color3.fromRGB(22, 28, 36),
            Toggle = Color3.fromRGB(33, 43, 54),
            ToggleFrame = Color3.fromRGB(0,0,0),
            ToggleToggled = Color3.fromRGB(22, 168, 76),
            Slider = Color3.fromRGB(33, 43, 54),
            SliderBar = Color3.fromRGB(25, 25, 25),
            SliderInc = Color3.fromRGB(60, 60, 60),
            Dropdown = Color3.fromRGB(33, 43, 54),
            DropdownItem = Color3.fromRGB(22, 28, 36),
            Textbox = Color3.fromRGB(33, 43, 54),
            TextboxFrame = Color3.fromRGB(22, 28, 36),
            Colorpicker = Color3.fromRGB(33, 43, 54),
            Label = Color3.fromRGB(33, 43, 54),
            Bind = Color3.fromRGB(33, 43, 54)
	}
    },
    Settings = {
        Theme = "BloodRed",
...
-- Main UI is the main frame in the gui with no scripts
...
-- circle effect when clicked on something
...
function SolarisLib:New(Config)
    ...
    function SettingsConstructor()
        ...
        function Settings:Tab(text, tier)
        ...
        general:ToggleSetting("Show Music On Launch", "Shows the music menu when you load Watty Hub", true, "ShowMusicOnLaunch")
    ...
    local TabHolder = {}
    function TabHolder:Tab(text, tier)
        if tier >= wtier then
            local Tab = TabPreset:Clone()
            ...
            local SectionHold = {}
            function SectionHold:Section(text, tier)
                if tier <= wtier then
                    ...
                    local ItemHold = {}
                    function ItemHold:Button(text, tier, callback)
                        if tier >= wtier then
                            ...
                            local ButtonHold = {}
                            function ButtonHold:Destory()
                                Button:Destroy()
                                breakr = true
                            end
                            function ButtonHold:SetText(txt)
                                Button.ButtonText.Text = txt
                                Button.Name = text .. "element"
                            end
                    ...
                    function ItemHold:Toggle(text,flag, tier,callback)
                        if tier >= wtier then
                            local Toggle = {Value = false}, 
                            local ToggleMain = game:GetObjects("rbxassetid://6963155498")[1]
                            local breakr = false
                            ...
                            function Toggle:SetText(txt)
                                Togglemain.ToggleText.Text = txt
                                ToggleMain.Name = txt .. "element"
                            end
                    ...
                    function ItemHold:Slider(text,min,max,inc,flag, tier, callback)
                        if tier >= wtier then
                            ...
                            local connectiona = SliderMain.SliderFrame.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = true end end)
                            local connectionb = SliderMain.SliderFrame.InputEnded:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = false end end)
                            local connectionc = game:GetService("UserInputService").InputChanged:Connect(function(input) if dragging and input.UserInputType == Enum.UserInputType.MouseMovement then move(input) end end)
                            ...
                            function Slider:UpdateText(txt)
                                SliderMain.SliderText.Text = txt
                            end
                    ...
                    function ItemHold:Dropdown(text,list,flag,tier,callback)
                        if tier >= wtier then
                    ...
                    function ItemHold:MultiDropdown(text,list,flag,tier,callback)
                        if tier >= wtier then
                    ...
                    function ItemHold:Colorpicker(text,preset,flag,tier,callback)
                        if tier >= wtier then
                            ...
                            local ColorPicker = {}
                            function ColorPicker:SetText() end
                            function ColorPicker:Destroy() end
                            ColorPicker.Visible = false
                            return ColorPicker
                        end
                    end
                    function ItemHold:Label(text, tier)
                        if tier >= wtier then
                            ...
                            function Label:SetText(tochange)
